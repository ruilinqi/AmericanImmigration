/**
  * This sketch demonstrates how to monitor监听 the currently active audio input 
  ...
  * it's feasible可行的 that the user may have the actual audio output of the computer 
