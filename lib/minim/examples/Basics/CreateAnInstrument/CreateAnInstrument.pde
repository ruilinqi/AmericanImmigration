/**
  * This sketch demonstrates how to create synthesized合成的 sound with Minim using an AudioOutput and
  * an Instrument we define. By using the playNote method you can schedule安排 notes to played 
  * at some point in the future, essentially allowing to you create musical scores with code. 
  * Because they are constructed with code, they can be either deterministic确定性的 or different every time. 
...
class SineInstrument implements Instrument
{
  ...
  {
    // make a sine wave oscillator振荡器
    // the amplitude振幅 is zero because 
  ...
  // this is called by the sequencer音序器 when this instrument
